...
filter_head.forEach(filter => {
  // let filter_type = filter.getAttribute('data-filter')
...
let home_btn = <HTMLSpanElement> document.getElementById('home_btn');
home_btn.addEventListener('click', () => {
  window.location.href = '/home'
})


let category_link_clothes = <HTMLAnchorElement> document.getElementById('category-link-clothes');
let category_link_shoes = <HTMLAnchorElement> document.getElementById('category-link-shoes');
let category_link_all = <HTMLAnchorElement> document.getElementById('category-link-all');
let size_link_U22 = <HTMLAnchorElement> document.getElementById('size-link-U22');
let size_link_adult = <HTMLAnchorElement> document.getElementById('size-link-adult');
let size_link_kids = <HTMLAnchorElement> document.getElementById('size-link-kids');
let size_link_all = <HTMLAnchorElement> document.getElementById('size-link-all');
let gender_link_male = <HTMLAnchorElement> document.getElementById('gender-link-male');
let gender_link_female = <HTMLAnchorElement> document.getElementById('gender-link-female');
let gender_link_all = <HTMLAnchorElement> document.getElementById('gender-link-all');
let gender_title = <HTMLElement> document.getElementById('gender_title');
let current_dir = <HTMLSpanElement> document.getElementById('current_dir');
...
window.onload = () => {
  ...
  let curr_location: str[] = window.location.search.split('&')
  let curr_location2: str[] = [];
